...
// A fixed message rather than one built per missing field — whatever
// combination of ftp/sweat_rate/weight is still a placeholder, the actionable
// takeaway for the athlete is the same either way: the plan is running on
// estimates until the real numbers are entered.
const BANNER_MESSAGE =
  "Tu estrategia actual usa valores estimados. Configura tu FTP y Peso en Perfil Fisiológico.";

const DISMISS_KEY = "profile_check_banner_dismissed";

/**
 * "Banner de Calibración de Perfil" — a dismissible top-of-dashboard nudge
 ...
 * (same convention as the planner's offline-strategy cache) — a
 * private-browsing/quota failure just means the dismiss doesn't persist
 * across sessions, never a broken banner.
 */
