...
export function StravaLoginButton() {
  ...
  return (
    <a
      ...
      className={cn(
        "flex w-full items-center justify-center gap-2 rounded-md bg-neutral-900 px-4 py-2.5 font-mono text-xs font-bold tracking-wider text-white uppercase transition-colors duration-150 sm:py-3",
